...
static int shutdown() {
    LOG(ERROR) << "imx Thermal HAL Service is shutting down.";
    return 1;
}
...
int main(int /* argc */, char** /* argv */) {
    ...
    LOG(INFO) << "imx Thermal HAL Service 2.0 starting...";
    ...
    LOG(INFO) << "imx Thermal HAL Service 2.0 started successfully.";
    joinRpcThreadpool();

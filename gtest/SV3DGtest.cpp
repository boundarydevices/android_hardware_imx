...
static int getGrids(float **gl_grid, uint32_t w, uint32_t h) {
    ...
    auto grid = CurvilinearGrid(SV_ANGLES_IN_PI, SV_Z_NOP, SV_X_STEP, w, h, evsRotations,
                                evsTransforms, Ks, Ds);
...
TEST(ImxSV, 3DSurroundViewCar) {
    ...
    glm::mat4 gProjection = glm::perspective(45.0f, (float)w / (float)h, 0.1f, 100.0f);
    for (int i = 0; i < 10; i++) {
        // Render car model
        ...
        glm::mat4 mv =
                glm::rotate(glm::rotate(glm::translate(glm::mat4(1.0f), glm::vec3(px, py, pz)), ry,
                                        glm::vec3(1, 0, 0)),
                            rx, glm::vec3(0, 0, 1));
        glm::mat4 carModelMatrix =
                glm::rotate(glm::rotate(glm::scale(glm::mat4(1.0f), car_scale),
        ...
        auto mn = glm::mat3(
                glm::rotate(glm::rotate(glm::rotate(glm::rotate(glm::mat4(1.0f), ry,
                                                                glm::vec3(1, 0, 0)),
                                                    rx, glm::vec3(0, 0, 1)),
                                        glm::radians(CAR_ORIENTATION_X), glm::vec3(1, 0, 0)),
                            glm::radians(CAR_ORIENTATION_Y), glm::vec3(0, 1, 0)));
...
TEST(ImxSV, 3DSurroundViewMashesCar) {
    ...
    for (int i = 0; i < 10; i++) {
        ...
        glm::mat4 mv =
                glm::rotate(glm::rotate(glm::translate(glm::mat4(1.0f), glm::vec3(px, py, pz)),
                                        glm::radians(ry + 30.0f * i), glm::vec3(1, 0, 0)),
                            rx, glm::vec3(0, 0, 1));
        ...
        glm::mat4 svModelMatrix =
                glm::rotate(glm::rotate(glm::scale(glm::mat4(1.0f), sv_scale),
                                        glm::radians(SV_ORIENTATION_X), glm::vec3(1, 0, 0)),
                            glm::radians(SV_ORIENTATION_Y), glm::vec3(0, 1, 0));
...
TEST(ImxSV, 3DSurroundViewTexturesCar) {
    ...
    for (int i = 0; i < 180; i++) {
        ...
        glm::mat4 mv =
                glm::rotate(glm::rotate(glm::translate(glm::mat4(1.0f), glm::vec3(px, py, pz)),
                                        glm::radians(ry - 0.2f * i), glm::vec3(1, 0, 0)),
    ...
    for (int i = 0; i < 360; i++) {
        ...
        glm::mat4 mv =
                glm::rotate(glm::rotate(glm::translate(glm::mat4(1.0f), glm::vec3(px, py, pz)),
                                        glm::radians(-60.0f), glm::vec3(1, 0, 0)),

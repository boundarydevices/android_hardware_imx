...
public:
     ...
     */
    static bool convertToEvsCameraParam(const string &id, CameraParam &camParam);
    /**
     * Convert a given string into android.hardware.graphics.common.PixelFormat
     */
    static bool convertToPixelFormat(const string &format, int32_t &pixelFormat);
    /**
     ...
     * Trim a string
     */
    static string trimString(const string &src, const string &ws = " \n\r\t\f\v");

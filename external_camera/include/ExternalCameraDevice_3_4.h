...
struct ExternalCameraDevice : public virtual RefBase {
    ...
    virtual sp<ICameraDevice> getInterface() { return new TrampolineDeviceInterface_3_4(this); }
...
protected:
    ...
    virtual sp<ExternalCameraDeviceSession> createSession(
            const sp<ICameraDeviceCallback>&, const ExternalCameraConfig& cfg,
    ...
    status_t initOutputCharskeysByFormat(
            ::android::hardware::camera::common::V1_0::helper::CameraMetadata*, uint32_t fourcc,
            const std::array<int, SIZE>& formats, int scaler_stream_config_tag,

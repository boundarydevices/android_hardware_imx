...
enum oemcrypto_command : uint32_t{
    ...
    OEMCRYPTO_CRYPTOENGINE_SETTIME = 53<<OEMCRYPTO_REQ_SHIFT,
    OEMCRYPTO_ENABLE_SECURE_MODE = 54<<OEMCRYPTO_REQ_SHIFT,
    OEMCRYPTO_DISABLE_SECURE_MODE = 55<<OEMCRYPTO_REQ_SHIFT,
    OEMCRYPTO_DERIVEKEYS_1 = 56<<OEMCRYPTO_REQ_SHIFT,
    OEMCRYPTO_LOADDRMPRIVATEKEY = 57<<OEMCRYPTO_REQ_SHIFT,
    OEMCRYPTO_REWRAPDEVICERSAKEY = 58<<OEMCRYPTO_REQ_SHIFT,
    OEMCRYPTO_ENABLE_G2D_SECURE_MODE = 59<<OEMCRYPTO_REQ_SHIFT,
    OEMCRYPTO_DISABLE_G2D_SECURE_MODE = 60<<OEMCRYPTO_REQ_SHIFT,
    OEMCRYPTO_G2D_SECURE_MODE = 61<<OEMCRYPTO_REQ_SHIFT
};
